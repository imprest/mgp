defmodule Mgp.Repo.Migrations.CreateInvoiceDetails do
  ...
  def change do
    ...
    execute(
      "ALTER TABLE invoice_details ADD CONSTRAINT invoice_details_invoice_id_no_key UNIQUE(sr_no, invoice_id)",
      "ALTER TABLE invoice_details DROP CONSTRAINT invoice_details_invoice_id_no_key"
    )
  end
end
